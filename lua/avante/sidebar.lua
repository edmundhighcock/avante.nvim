...
function Sidebar:get_result_container_height()
  ...
  local token_usage_container_height = self:get_token_usage_container_height()
...
function Sidebar:render(opts)
  ...
  self:create_token_usage_container()
...
function Sidebar:create_token_usage_container()
  local token_usage_config = Config.behaviour.token_usage_tracking
  if not token_usage_config.enabled then
...
function Sidebar:get_token_usage_container_height()
  local config = Config.behaviour.token_usage_tracking
  ...
  if usage_analysis.total_tokens == 0 then return 0 end

  return math.min(config.window_height or 3, math.max(1, vim.o.lines - 5))
end
